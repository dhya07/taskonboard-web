...
import TobLogo from '../assets/Logo/tob-logo-dark.png'
    ...
    <div className="min-h-screen bg-[#1a2332] text-white overflow-hidden">
      ...
      <header className="container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <img src={TobLogo} alt="TaskOnBoard" className="w-48 h-auto object-contain" />
        </div>
      ...
      <div className="container mx-auto px-6 py-12 lg:py-20">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6">
                Download our app<br />
                and <span className="text-[#32A49D]">start getting<br />things done</span>
              </h1>
          ...
          <div className="relative h-[600px] hidden lg:block">
            ...
            <div className="absolute top-0 left-0 w-72 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 transform -rotate-6 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="mt-2 flex items-center space-x-2">
                <span className="text-xs bg-[#32A49D] text-black px-2 py-1 rounded">⭐ 4.9</span>
            ...
            <div className="absolute top-32 right-0 w-72 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 transform rotate-6 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="mt-2 flex items-center space-x-2">
                <span className="text-xs bg-[#32A49D] text-black px-2 py-1 rounded">⭐ 4.8</span>
            ...
            <div className="absolute bottom-0 left-12 w-72 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 transform -rotate-3 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="mt-2 flex items-center space-x-2">
                <span className="text-xs bg-[#32A49D] text-black px-2 py-1 rounded">✓ Verified</span>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8 text-center">
          <div>
            <div className="flex items-center justify-center mb-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-[#32A49D] to-[#32A49D] border-2 border-[#1a2332]"></div>
                ))}
              </div>
            </div>
          ...
          <div>
            <div className="w-12 h-12 bg-[#32A49D] rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl">✓</span>
            </div>
            <h3 className="text-xl font-bold mb-2">Post Task, Get Offers</h3>
            <p className="text-gray-400">Receive offers from verified taskers in your area within minutes.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400">Browser offers from takers who are ready to get the job done.</p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20">
            <span className="text-[#32A49D]">✓</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start mb-2">
                <img src={TobLogo} alt="TaskOnBoard" className="w-40 h-auto object-contain" />
              </div>
            </div>
