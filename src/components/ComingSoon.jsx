        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#"
                className="bg-white text-black px-6 py-3 rounded-xl flex items-center space-x-3 hover:bg-gray-100 transition"
              >
                <svg
                  className="w-8 h-8"
                  viewBox="0 0 24 24"
          ...
          <div className="relative h-[600px] hidden lg:block">
            ...
            <div className="absolute top-0 left-0 w-72 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 transform -rotate-6 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="mt-2 flex items-center space-x-2">
                <span className="text-xs bg-[#32A49D] text-black px-2 py-1 rounded">
                  ⭐ 4.9
                </span>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex items-center justify-center mb-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-[#32A49D] to-[#32A49D] border-2 border-[#1a2332]"
                  ></div>
                ))}
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-gray-400">
              Receive offers from verified taskers in your area within minutes.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400">
              Browser offers from takers who are ready to get the job done.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20">
            ...
            <span className="text-sm">
              Built with safety, trust & transparency
            </span>
          </div>
        </div>
      </div>
