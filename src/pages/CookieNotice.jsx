  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="TaskOnBoard Cookie Notice - Learn how we use cookies and similar technologies."
        />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Cookies allow us to recognize your device and remember
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#1a2332] mb-4">
                2. How TaskOnBoard Uses Cookies
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mt-4">
                <strong>Duration:</strong> These cookies are typically session
                cookies that expire when you close your browser, or persistent
                cookies that last up to 1 year.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                These cookies allow you to share content and interact with
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Some cookies on our site are set by third-party services. These
                include:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                ...
                <li>
                  <strong>Hotjar:</strong> User behavior analytics
                </li>
                <li>
              ...
              <p className="text-gray-700 leading-relaxed mt-4">
                ...
                privacy policies of these services for information about their
                cookie practices.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Small graphic images embedded in emails and web pages to track
                user activity, such as whether an email was opened or a page was
                viewed.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                HTML5 local storage allows us to store larger amounts of data on
                your device for features like offline functionality and faster
                loading times.
              </p>

              <h3 className="text-xl font-semibold text-[#1a2332] mb-3 mt-6">
                5.3 Mobile Device Identifiers
              </h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Our mobile apps may collect device identifiers (such as IDFA on
                iOS or Android ID) for analytics, advertising, and app
                functionality.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  ...
                  Apps to Request to Track (disable)
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                While you can block or delete cookies, please note that this may
                affect your experience:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  You may need to re-enter your login credentials frequently
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                is no universal standard for how DNT signals should be
                interpreted. TaskOnBoard does not currently respond to DNT
                signals, but we respect your privacy choices made through cookie
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                changes in technology, legislation, or our cookie practices. We
                will notify you of material changes by posting a notice on our
                platform or sending you an email.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                Please check this page periodically for updates. The "Last
                updated" date at the top indicates when this notice was last
                revised.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <Link to="/privacy" className="text-[#4ade80] hover:underline">
                  Privacy Policy
                </Link>
                .
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                For information about our terms and conditions, please see our{" "}
                <Link to="/terms" className="text-[#4ade80] hover:underline">
                  Terms of Use
                </Link>
                .
              </p>
